...
const CandyStores = () => {
    return(
        <Container direction='column' align='center' justify='center'>
            <Heading fontWeight={700} fontSize='4xl' m={'1rem'} mb={'2rem'}> Our Candy Stores: </Heading>
            ...
            <Text color={'tomato'} fontSize='2xl' m={'1rem'} mt={'2rem'}>All our products are available in stores too!</Text>
        </Container>
    )
};
